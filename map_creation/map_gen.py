...
from map_types.up_down import MapGenerator as UpDownMapGen

parser = argparse.ArgumentParser(description="Parallel OMPL Car Planners")

parser.add_argument('-s','--size', type=int, default=0, help='Number of size maps')
parser.add_argument('-t','--turning', type=int, default=0, help='Number of turning radius maps')
parser.add_argument('-r','--random', type=int, default=0, help='Number of random rectangle maps')
parser.add_argument('-u','--updown', type=int, default=0, help='Number of up-down maps')
...
parser.add_argument('--res', type=int, default=(500,500), nargs=2, help='Map dimensions (not used)')
...
if __name__ == "__main__":
    ...
    generators = {
        ...
        'updown': UpDownMapGen(args.res[0], args.res[1], R, start_pos, stop_pos)
    }
