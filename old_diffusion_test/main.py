...
MAX_ITERS = 100000         # Maximum number of iterations for the planner
...
class SSTPlanner:
    ...
    def plan(self, animation = True, first_solution=False):
            ...
            if can_add:
                ...
                if dist_to_goal < GOAL_TOLERANCE:
                    ...
                    if potential_cost < self.best_cost:
                        ...
                        if first_solution:
                            print(f"First solution found at iter {i}. Returning early.")
                            self.best_solution_node = x_new
                            return self._reconstruct_path()
